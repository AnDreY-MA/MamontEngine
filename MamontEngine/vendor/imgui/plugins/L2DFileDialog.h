...
namespace FileDialog
{
    ...
    void ShowFileDialog(
            bool *open, char *buffer, [[maybe_unused]] unsigned int buffer_size, FileDialogType type = FileDialogType::OpenFile, const char *window_title = "Title")
    {
        ...
        if (open)
        {
            ...
            std::string selected_file_path = file_dialog_current_path + (file_dialog_current_path.back() == '\\' ? "" : "\\") +
    ...
    void ShowFileDialog_s(bool *open, char *buffer, FileDialogType type = FileDialogType::OpenFile, const char *window_title = "Title")
    {
        ShowFileDialog(open, buffer, 500, type, window_title);
    }
